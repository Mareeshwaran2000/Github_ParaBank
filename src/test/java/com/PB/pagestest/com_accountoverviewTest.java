...
public class com_accountoverviewTest extends PBbasesetup {
	@BeforeClass
	...
	public void headertextTest() {
		...
		Assert.assertEquals(Act_header, com_constant_util.PB_ACCOUNTOVERVIEW_HEADER);
	}
	@Test(priority=3)
	...
	public void Acc_headerTest() {
		...
		Assert.assertEquals(text, com_constant_util.PB_ACCOUNT_HEADER);	
	}
	@Test(priority=9)
	...
	public void acc_activityTest() {
		...
		Assert.assertEquals(Act_msg, com_constant_util.PB_ACCOUNTOVERVIEW_TRANS_MSG);	
	}
